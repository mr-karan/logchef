...
description: Explore Logchef's Log Explorer UI, LogchefQL and native SQL/LogsQL query modes, time range controls, and result views.
---
...
Save frequently used queries to your team's collection via the **Save** button. Saved queries preserve the time range, variables, and mode. See [Collections & Saved Queries](/features/collections) for roles and sharing.

## Next steps

- Pin saved queries to a shared [Dashboard](/features/dashboards)
- Explore fields visually with the [Field Values Sidebar](/features/field-sidebar)
- Set up [Alerting](/features/alerting) on a query instead of watching it manually
