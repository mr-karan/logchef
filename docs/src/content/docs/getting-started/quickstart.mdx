...
curl -L -O https://github.com/mr-karan/logchef/releases/download/v1.6.1/logchef_1.6.1_linux_amd64.tar.gz

# Extract the archive
tar xzf logchef_1.6.1_linux_amd64.tar.gz
...
```
namespace="syslogs" and body="error"
```
