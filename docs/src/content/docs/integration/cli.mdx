...
Grab the latest version tag from the [CLI releases page](https://github.com/mr-karan/logchef/releases?q=cli&expanded=true) (e.g. `0.2.0`), set it once, then download:
