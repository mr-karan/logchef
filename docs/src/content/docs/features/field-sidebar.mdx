---
title: "Field Values Sidebar: Explore & Filter Logs by Field"
...
- Learn the filters the sidebar writes for you in [Search Syntax](/guide/search-syntax)
- See [Query Examples](/guide/examples) for more LogchefQL patterns
- Review the [Query Interface](/user-guide/query-interface) for the rest of the explorer
