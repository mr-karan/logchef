---
title: "AI SQL Generation: Natural Language to ClickHouse Queries"
...
Always review AI-generated SQL before running it. The model can get complex aggregations or unfamiliar schemas wrong, so start with simple questions and iterate from there.
