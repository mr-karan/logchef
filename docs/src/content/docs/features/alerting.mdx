---
title: Alerting
description: Set up scheduled log alerts on ClickHouse or VictoriaLogs sources with email and webhook notifications when thresholds are exceeded.
---
...
replicas against a shared [Postgres backend](/operations/database-backends/).
